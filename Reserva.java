...
public class Reserva {
    ...
    public Reserva(int id, Cliente cliente, Local local, List<Equipamento> equipamentos,
                   LocalDateTime dataHoraInicio, LocalDateTime dataHoraFim,
                   String status, Pagamento pagamento) {
        this.id = id;
    ...
    public String toString() {
        return "Reserva [id=" + id + ", cliente=" + cliente.getNome() + ", local=" + local.getNome() + "]";
    }
}
